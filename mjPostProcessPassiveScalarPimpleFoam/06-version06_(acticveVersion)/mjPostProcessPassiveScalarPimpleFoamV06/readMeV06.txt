...
****************************************************************************************************************************************
	...
	Last modified: April 20, 2021 by MJ (version06)
	Tested on: OpenFOAM v2012 , v2006		       

		1. calculate the SGS turbulent kinetic energy (kSGS) 
		2. calculate the total (SGS + resolved) turbulent kinetic energy 
		3. calculate SGS turbulent dissipation rate at runtime during LES simulations (epsilonSGS). 
		4. calculate total (SGS + resolved) dissipation rate at runtime during LES simulations (epsilonSGS). 

		5. It can be easily extended to include all the terms of the turbulent kinetic energy budget.

	    6. The LES resolution index is also calculated at runtime.
...
****************************************************************************************************************************************
	Version06
	Last modified: April 18, 2021 by MJ
	Last modified: April 20, 2021 by MJ
	Tested on: OpenFOAM v2012 , v2006		       
